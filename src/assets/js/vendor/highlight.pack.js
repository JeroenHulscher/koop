...
name:"JSON",contains:t,keywords:e,illegal:"\\S"}}}());hljs.registerLanguage("makefile",function(){"use strict";return function(e){
...
end:/$/,keywords:{$pattern:/[\.\w]+/,"meta-keyword":".PHONY"}},s]}}}());hljs.registerLanguage("javascript",function(){"use strict"
...
begin:/:\s*/,end:/$/,excludeBegin:!0}]}]}}}());hljs.registerLanguage("ruby",function(){"use strict";return function(e){
var n="[a-zA-Z_]\\w*[!?=]?|[-+~]\\@|<<|>>|=~|===?|<=>|[<>]=?|\\*\\*|[-/+%^&*~`|]|\\[\\]=?",a={
...
name:"TypeScript",aliases:["ts"]}),g}}());hljs.registerLanguage("scss",function(){"use strict";return function(e){
