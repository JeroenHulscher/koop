...
function valideerRichtlijnJaar(n, t) {
  t.IsValid = !t.Value || t.Value === document.getElementById(n.controltovalidate).txt || (parseInt(t.Value, 10) > 1e3 && parseInt(t.Value, 10) <= new Date().getFullYear());
}
...
var Page_Validators =  new Array(document.getElementById("ctl00_ctl00_cphContent_zoekpaginaContent_ZoekformulierUitgebreid_valideerBWBID"),document.getElementById("ctl00_ctl00_cphContent_zoekpaginaContent_ZoekformulierUitgebreid_valideerJuriconnectID"));
...
ctl00_ctl00_cphContent_zoekpaginaContent_ZoekformulierEURichtlijn_valideerRichtlijnJaarEnNummer.controltovalidate = "ZoekOp_BesluitnummerDeel1";
